...
Функция ПолучитьГоризонтальноеПоложение(ШифрПоложения)
	Если ШифрПоложения = 1 Тогда
		ГоризонтальноеПоложение = ГоризонтальноеПоложениеЭлемента.Лево;
	ИначеЕсли ШифрПоложения = 2 Тогда
		ГоризонтальноеПоложение = ГоризонтальноеПоложениеЭлемента.Центр;
	ИначеЕсли ШифрПоложения = 3 Тогда
		ГоризонтальноеПоложение = ГоризонтальноеПоложениеЭлемента.Право;
	Иначе
		ГоризонтальноеПоложение = ГоризонтальноеПоложениеЭлемента.Авто;
	КонецЕсли;
	Возврат ГоризонтальноеПоложение;
КонецФункции
